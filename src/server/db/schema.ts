...
export const schools = createTable(
  "schools",
  {
    ...
    schoolUsername: varchar("school_username", { length: 255 }).unique().notNull(),
...
export const students = createTable(
  "students",
  {
    ...
    schoolId: integer("school_id").notNull().references(() => schools.schoolId, {
      onDelete: "cascade"
    }),
...
export const results = createTable(
  "results",
  {
    ...
    studentId: integer("student_id").notNull().references(() => students.studentId, {
      onDelete: "cascade"
    }),
    ...
    bestThrowingScore: decimal("best_throwing_score", { precision: 10, scale: 2 }),
