  ...
  return (
    <section id="the-competition" className="md:mt-12">
      <div className="flex items-center justify-center">
        <div className="the-competition-bg w-full min-h-[759px] flex items-center justify-center max-w-[1440px]">
            <div className="mx-auto max-w-6xl box-content rounded-lg p-4 pt-16">
                ...
                <div className="mb-4 flex w-full flex-col items-start justify-between lg:mb-0 lg:mr-4 lg:w-1/3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="mt-4 text-left text-[1rem] font-medium leading-6 tracking-tight text-gray-800">
                      ...
                      for girls and boys. The Athletics Kids Cup 2024/2025 is
                      open to children who will be 15 years old or younger in
                      2024 (born in 2009 or later).
                    </p>
                  </div>
                </div>
                <div className="text-left">
