...
const TelInputField: React.FC<ITelInputField> = ({ labelName, isRequired, validationError }) => {
  ...
  return (
    <div>
      <label className="block text-xs leading-5 .text-gray-700 mb-1">{labelName}
        ...
        {validationError && <span className="text-red-600 block">{validationError}</span>}
      </label>
      <input
        name={inputFieldName}
        // minLength={10}
