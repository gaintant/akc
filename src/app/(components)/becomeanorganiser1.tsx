    ...
    <div className="order-2 mb-4 w-full min-w-[300px] md:order-1 md:mb-0 md:ml-24 md:w-3/4 md:px-12">
      <div className="md:mt-8">
        ...
        <p className="mt-6 text-lg">
          We offer an unbeatably attractive package for all schools that want to get their students moving. 
          Through the Athletics Kids Cup, we provide the ideal platform for children to build and strengthen 
          their character, values, integrity, mutual respect and personal discipline. 
          We inspire them to get the best out of themselves and to pursue their own ambitious goals.
        </p>
